...
Config.GATE_FILL_COLOR = '#FAF8F6';
Config.HIGHLIGHTED_GATE_FILL_COLOR = '#F4C9B5';
Config.TIME_DEPENDENT_HIGHLIGHT_COLOR = '#F5E7B8';

// Mixed-state displays are green.
Config.DISPLAY_GATE_IN_TOOLBOX_FILL_COLOR = '#DCEFE2';
Config.DISPLAY_GATE_BACK_COLOR = '#E8F4EC';
Config.DISPLAY_GATE_FORE_COLOR = '#6E9F7A';

// Changes are yellow.
Config.OPERATION_BACK_COLOR = '#F7F0D8';
Config.OPERATION_FORE_COLOR = '#B89A4A';

// Pure-state displays are cyan.
Config.SUPERPOSITION_BACK_COLOR = '#E8F0F7';
Config.SUPERPOSITION_MID_COLOR = '#B8D3E8';
Config.SUPERPOSITION_FORE_COLOR = '#6D9DB8';
...
// Toolbox layout.
Config.BACKGROUND_COLOR_TOOLBOX = '#E9E7E5';
